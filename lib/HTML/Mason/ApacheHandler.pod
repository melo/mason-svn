...
See the L<HTML::Mason::Devel/sending_http_headers> of the Component Developer's
...
Component L<HTML::Mason::Admin/debugging> procedures are fully described in the I<Mason
...
appropriate. Default is 1. See L<HTML::Mason::Admin/Allowing directory requests>
...
have overriden the L<HTML::Mason::Interp/die_handler> Interp parameter.

=item output_mode

This parameter has been replaced by the equivalent Interp parameter
L<HTML::Mason::Interp/out_mode>. For backward compatibility, setting
