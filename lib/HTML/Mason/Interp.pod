...
L<HTML::Mason::Devel/autohandlers> section of the Component Developer's Guide for a
...
Default is 10 MB. See the L<HTML::Mason::Admin/Code Cache> section of the I<Admin Guide>
for further details.
...
L<HTML::Mason::Admin/staging vs production> section of the I<Admin Guide> for a
...
are frequently viewed and rarely updated.  See the L<HTML::Mason::Admin/preloading>
...
explicitly updated L<HTML::Mason::Admin/reload file>.
...
Parser parameter L<HTML::Mason::Parser/in_package>.  The lines above, for example,
are equivalent to:
...
parameter L<HTML::Mason::Parser/allow_globals>; otherwise you'll get warnings from
C<strict>.
