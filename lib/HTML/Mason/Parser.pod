...
See also L<HTML::Mason::Admin/Object files>.
...
compiled subroutine. Blank by default. See L<HTML::Mason::Parser/preamble>.
...
files that you don't want the end user to see. See L<HTML::Mason::Parser/preprocess>.
...
request object). See L<HTML::Mason::Parser/postamble>.
...
one way to extend the HTML::Mason syntax with new tags, etc. See L<HTML::Mason::Parser/postprocess>.
...
The only exception is L<HTML::Mason::Parser/allow_globals>, which works a bit differently.
