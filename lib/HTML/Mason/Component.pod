...
L<HTML::Mason::Request/current_comp>, L<HTML::Mason::Request/callers>, and L<HTML::Mason::Request/fetch_comp> Request methods.

There is no published C<new> method, because creating a component
requires a parser. Use the L<HTML::Mason::Parser/make_component> Parser method to create a
...
Like L<HTML::Mason::Component/call_method (name, args...)>, but returns the method
