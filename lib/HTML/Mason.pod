...
The paragraphs below assume some knowledge of mod_perl and Apache
configuration. If you're rusty on any these topics, bone up by reading
the documentation available at http://www.apache.org (Apache) and
http://perl.apache.org (mod_perl). Here you will also find
subscription details for the mod_perl mailing list--in my view the
best mod_perl resource around.
...
eg/httpd.conf in your distribution.
...
Mason handler. If you only wish to try out Mason in a subdirectory,
do this:
